...
var points = [];
var Connection = [];
var all_ab_connections =[];
var all_depXcon = [];
var all_arrival_for_a_spec_dep_CLONE =[];
var startPoint = [];
var endPoint = [];
var pathfinder = [];
//-----End ---------
...
var end_point_D = '';
var end_point_A=''
var end_point_minus1_D_A=''
var end_point_minus1_D='';
var end_point_minus1_A='';
var star_point_plus1_D_A=''
var star_point_plus1_D='';
var star_point_plus1_A='';

var pathFindDeparture = '';
var pathFindArrival = '';
var pathFound = false;
...
function getIndirectDeals(from, to)
{
    if (deals.length > 0) {
...
function pathfinder_arrival(dep, key)
{   
    //debugger;
    for(var i=0; i<Connection.length; i++)
    {
